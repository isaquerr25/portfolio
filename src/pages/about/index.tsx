...
function About() {
	return (
		<Flex className="Skills" flexDirection={'column'} overflowX={'hidden'} ml={'3vw'}  position='relative'  w='100vw' >
			...
			<Flex w={'100%'} justifyContent='space-between' >
				<Image src={ImgAboutMe} h={['30px','3vw']} mt={'20px'} alt='Dan Abramov' />
			</Flex>
			...
			<Flex w='99vw'  >
				...
				<Flex   justifyContent={'center'}  w={'100%'} flexDirection={'column'} gap={'10px'} mt={'20px'}>
					...
					<Text fontSize={['sm','1.5vw']} display='inline-block'  gap={'2px'}
			...
			<Flex w={'100vw'} justifyContent='center' h={['150','29vw']} alignItems='center' overflowY='hidden' >
				<Image src={ImgViolin} h={['150px','30vw']} w={'auto'}  alt='Dan Abramov' zIndex={-999} />
			</Flex>
