					...
					>
						...
						>
							...
							>
								...
								>
									<Text as={"span"} color={"#EDFF7B"}>
										Since I started my journey as a
										freelance developer almost
										...
										. And collaborated with talented people
										to create web products for commercial
										and consumer use.
										<br />
										<br />I create successful responsive
										websites that are fast, easy to use and
										built with best practices. The main area
										of my experience is front-end
										development using
										<Text as={"span"} color={"#FFFFFF"}>
											{" "}
											React{" "}
										</Text>
										building small and medium sized web
										apps, custom plugins, features,
										animations and coding of interactive
										layouts.
										<br />
										<br />I also develop backend services
										using
										<Text as={"span"} color={"#FFFFFF"}>
											{" "}
											JS, TS and Python.{" "}
										</Text>
										I have experience in game development
										using
										<Text as={"span"} color={"#FFFFFF"}>
											{" "}
											Unity in C#.{" "}
