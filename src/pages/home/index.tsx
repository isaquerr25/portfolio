				...
				<Flex ml='1.5rem'>
					...
					>
						...
						<Text display='inline-block' textShadow={'4xl'} pl={'20px'}>
							...
							, as a programmer and designer, I have worked with several
							up-and-coming companies and startups to help them{' '}
							<Text as={'span'} color={'white'}>
								successfully reach their full potential and new clients.
							</Text>
						</Text>
						<br />
						{'/>'}
